/*
 * <h1>Sistema simulador de la gestión de alojamientos en alquiler<h1>
 * <h2>Trabajo entornos de desarrollo<h2>
 * 
 * @author: Sergio Herrero, Mohammed El Bouhamdi, Erik James 09/05/2021
 * 
 * @version: 1.0
 * 
 */
...
public class GestionAlojamientos {
	...
	public static void main(String[] args) {
		...
		//Generamos distintos alojamientos y los mostramos
	...
	//Creamos distintos alojamientos y los añadimos a la lista alojamientos
	//@param: alojamientos -> lista del tipo abstracto alojamiento
	...
	}//Fin crearAlojamientos

	//Metodo para mostrar los distintos alojamietnos almacenados en la lista
	//@param: alojamientos -> lista del tipo alojamientos
	...
	}//Fin mostrarAlojamientos
	
	
	//Metodo para añadir un alojamiento especifico a la lista
	//@param: alojamientos -> lista del tipo Alojamiento
	//@param: alojamiento -> Objeto del tipo alojamiento
	...
	//Metodo para buscar un alojamiento concreto en la lista
	...
	//Metodo para calcular el precio del alquiler del alojamiento
	//@param: alojamientos -> lista de alojamientos
	...
	}//Fin calculaPrecioAlquiler

	//Metodo para mostrar el precio de todos los alojamientos durante un tiempo especificado
	//@param: alojamientos -> lista del tipo alojamiento
